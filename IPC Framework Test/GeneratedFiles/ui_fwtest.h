...
"color: rgb(255, 255, 255);"));
        ...
        label_5->setGeometry(QRect(150, 0, 681, 61));
...
"border-color: rgb(0, 0, 0);"));
        ...
        sendUDP->setGeometry(QRect(730, 390, 75, 23));
    ...
    void retranslateUi(QMainWindow *fwtestClass)
    {
        ...
        label_5->setStyleSheet(QApplication::translate("fwtestClass", "background-color: rgb(255, 255, 255);", 0, QApplication::UnicodeUTF8));
        ...
        sendUDP->setText(QApplication::translate("fwtestClass", "Send UDP", 0, QApplication::UnicodeUTF8));

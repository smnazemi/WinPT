...
//        return (SUCCEEDED(StringCchPrintfA(pszIPAddr, nSize, _T("%u.%u.%u.%u"),
//                            (UINT)(((PBYTE) &ulAddr)[0]),
//                            (UINT)(((PBYTE) &ulAddr)[1]),
//                            (UINT)(((PBYTE) &ulAddr)[2]),
//                            (UINT)(((PBYTE) &ulAddr)[3]))));
